...
class JDETracker(object):
    ...
    def update(self, im_blob, img0):
        ...
        with torch.no_grad():
            ...
            f = self.model.part1(im_blob, [36, 61,  74])
            f_low, shape = self.model.mlt.transform(f)
            f_rec = self.model.mlt.invtransform(f_low, shape)
            # f_rec = f 
            pred  = self.model.part2(f_rec, [36, 61,  74], 75)
